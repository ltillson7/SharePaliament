...
<html lang="en">
    ...
    <main id="main">
        <h2>Share Parliamentary Bills! <img id="flag" src="images/Flag_of_Canada.PNG" alt="Canadian Flag"/></h2>
        <p>This Page is to easily share information about Parliamentary Bills. </p>
        <div class="container">
            <div class="card-deck">
                <?php
                    require_once "parliament.php";
                ?>
            </div>
        </div>
    </main>
